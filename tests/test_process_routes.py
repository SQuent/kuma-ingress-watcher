...
class TestProcessRoutes(unittest.TestCase):
    ...
    def test_process_routes_single_route(self, mock_extract_hosts, mock_create_or_update_monitor):
    ...
    @patch('kuma_ingress_watcher.controller.create_or_update_monitor')
    @patch('kuma_ingress_watcher.controller.extract_hosts')
    def test_process_routes_multiple_routes(self, mock_extract_hosts, mock_create_or_update_monitor):
        ...
        calls = [
            unittest.mock.call('test-monitor-1', 'https://example.com:8080', 60, 'http', None, 'GET'),
            unittest.mock.call('test-monitor-2', 'https://example.org:8080', 60, 'http', None, 'GET')
        ]
        mock_create_or_update_monitor.assert_has_calls(calls)

    @patch('kuma_ingress_watcher.controller.create_or_update_monitor')
    @patch('kuma_ingress_watcher.controller.extract_hosts')
    def test_process_routes_no_hosts(self, mock_extract_hosts, mock_create_or_update_monitor):
    ...
    @patch('kuma_ingress_watcher.controller.create_or_update_monitor')
    @patch('kuma_ingress_watcher.controller.extract_hosts')
    def test_process_routes_with_empty_port(self, mock_extract_hosts, mock_create_or_update_monitor):
        mock_extract_hosts.return_value = ['example.com']
